...
var isURL=trustedTypes.isURL?trustedTypes.isURL:function(value){return false;};toStringOrTrustedType=function toStringOrTrustedType(value){if((typeof value==='undefined'?'undefined':_typeof(value))==='object'&&(isHTML(value)||isScript(value)||isScriptURL(value)||isURL(value))){// Pass Trusted Types through.
...
for(var i=1;i<queuedDiscreteEvents.length;i++){var queuedEvent=queuedDiscreteEvents[i];if(queuedEvent.blockedOn===unblocked){queuedEvent.blockedOn=null;}}}if(queuedFocus!==null){scheduleCallbackIfUnblocked(queuedFocus,unblocked);}if(queuedDrag!==null){scheduleCallbackIfUnblocked(queuedDrag,unblocked);}if(queuedMouse!==null){scheduleCallbackIfUnblocked(queuedMouse,unblocked);}var unblock=function unblock(queuedEvent){return scheduleCallbackIfUnblocked(queuedEvent,unblocked);};queuedPointers.forEach(unblock);queuedPointerCaptures.forEach(unblock);}/**
 ...
 */function shallowEqual(objA,objB){if(is$1(objA,objB)){return true;}if((typeof objA==='undefined'?'undefined':_typeof(objA))!=='object'||objA===null||(typeof objB==='undefined'?'undefined':_typeof(objB))!=='object'||objB===null){return false;}var keysA=Object.keys(objA);var keysB=Object.keys(objB);if(keysA.length!==keysB.length){return false;}// Test for A's keys different from B.
...
var _TerminalScreen = __webpack_require__(19);

var _TerminalScreen2 = _interopRequireDefault(_TerminalScreen);
...
var App = function (_Component) {
    ...
    _createClass(App, [{
        ...
        value: function componentDidMount() {
            _lightningContainer2.default.addMessageHandler(this.messageRecievedHandler.bind(this));
        }
    }, {
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement(_TerminalScreen2.default, { text: this.state.message })
            );
        }
    }]);
...
// module
exports.push([module.i, ".terminal-window {\n    background-color: black;\n    color: green;\n    font-family: \"Courier\";\n    height: 300px;\n    padding: 10px;\n    width: 400px;\n}", ""]);
